...
See also:
- `Readme/WIRED_WIRELESS_SETUP.md` for full wired and wireless setup instructions.
- `Readme/WORLD_FRAME_MAPPING.md` for the 1.0 world-delta hand-to-EE mapping behavior.
...
Main tuning file:
- `/Users/noahli/ros_unity_project/ros_backend1.0/src/teleop_bridge/config/teleop_tuning.yaml`
