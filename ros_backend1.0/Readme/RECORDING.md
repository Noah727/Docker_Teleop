...
```text
/Users/noahli/ros_unity_project/UnityApp/Assets/Scripts/GripperCameraRecorder.cs
```
...
```text
/Users/noahli/ros_unity_project/UnityApp/Assets/Scenes/Ur5e_Working 1.unity
```
