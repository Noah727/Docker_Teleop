...
Evaluation helper scripts live under `ros_backend1.1/scripts/test_tools/eval_scripts/`. The repository intentionally excludes raw recordings, large trace outputs, and irrelevant thesis materials.
