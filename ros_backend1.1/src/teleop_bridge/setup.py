...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'coupled_hande_gripper_controller = teleop_bridge.coupled_hande_gripper_controller:main',
            ...
            'gazebo_contact_haptic_publisher = teleop_bridge.gazebo_contact_haptic_publisher:main',
            'rubik2x2_mechanism_controller = teleop_bridge.rubik2x2_mechanism_controller:main',
            'keyboard_servo_cmd = teleop_bridge.keyboard_servo_cmd:main',
        ],
    },
)
