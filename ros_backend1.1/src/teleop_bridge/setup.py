...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'keyboard_single_arm_controller = teleop_bridge.optional_inputs.keyboard_single_arm_controller:main',
            'spacemouse_single_arm_controller = teleop_bridge.optional_inputs.spacemouse_single_arm_controller:main',
            'spacemouse_tcp_target_bridge = teleop_bridge.optional_inputs.spacemouse_tcp_target_bridge:main',
            ...
            'keyboard_target_override = teleop_bridge.optional_inputs.keyboard_single_arm_controller:main',
            'spacemouse_target_override = teleop_bridge.optional_inputs.spacemouse_single_arm_controller:main',
            'spacemouse_host_target_bridge = teleop_bridge.optional_inputs.spacemouse_tcp_target_bridge:main',
        ],
    },
)
